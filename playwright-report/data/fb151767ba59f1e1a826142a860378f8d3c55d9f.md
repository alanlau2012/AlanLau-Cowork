...
- generic [ref=e2]:
  ...
  - generic [ref=e23]:
    - generic [ref=e24]:
      ...
      - generic [ref=e42]:
        - generic [ref=e45]:
          - textbox "Reply... (Shift+Enter for new line)" [ref=e46]
          - generic [ref=e47]:
            - generic [ref=e48]:
    ...
    - complementary:
      - generic [ref=e65]:
        - heading "Progress" [level=3] [ref=e66]
        - button "Toggle sidebar" [active] [ref=e67] [cursor=pointer]:
          - img [ref=e68]
      - generic [ref=e70]:
        - button "任务" [ref=e71] [cursor=pointer]
        - button "活动" [ref=e72] [cursor=pointer]
      - generic:
        - generic:
          - generic [ref=e73] [cursor=pointer]:
            - img
            - generic [ref=e75]: 0 steps
          - generic [ref=e76]:
            - generic: No active tasks
```